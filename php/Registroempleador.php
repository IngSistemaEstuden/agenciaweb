...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if ($apellidoM === null) {
            $sql2 = "INSERT INTO empleador (IdUsuario, Nombre, ApellidoP, Celular, Direccion, CI) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            $sql2 = "INSERT INTO empleador (IdUsuario, Nombre, ApellidoP, ApellidoM, Celular, Direccion, CI) VALUES (?, ?, ?, ?, ?, ?, ?)";
            $stmt2 = $conexion->prepare($sql2);
            if (!$stmt2) {
                throw new Exception("Error en la preparación de la consulta: " . $conexion->error);
            }
...
<head>
    ...
    <link rel="stylesheet" href="../css/estiloempleador.css">
</head>
<body>
    <div class="container">
        <div class="imagen"></div>
        <div class="formulario">
            <h1>Registro de Empleador</h1>
            <form action="Registroempleador.php" method="POST">
