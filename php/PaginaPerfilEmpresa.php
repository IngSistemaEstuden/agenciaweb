        ...
        if (!in_array($imageExtension, $validImageExtension)) {
            ...
            if (move_uploaded_file($tmpName, '../img/' . $newImageName)) {
                ...
                if (mysqli_query($conexion, $query)) {
                    echo "<script>alert('Imagen actualizada con éxito'); document.location.href = 'PaginaPerfilEmpresa.php';</script>";
                } else {
...
if (isset($_POST["submit_info"])) {
    ...
    $query = "UPDATE empresa SET NombreEmpresa='$nombreempresa', TelefonoCelular='$celular', Direccion='$direccion', NIT='$nit' WHERE IdUsuario='$IdUsuario'";
    ...
    if (mysqli_query($conexion, $query) && mysqli_query($conexion, $query2)) {
        echo "<script>alert('Información actualizada con éxito'); document.location.href = 'PaginaPerfilEmpresa.php';</script>";
    } else {
...
if (isset($_POST["submit_servicio"])) {
    ...
    if (mysqli_query($conexion, $query_servicio)) {
        ...
        if (mysqli_query($conexion, $query_publicacion)) {
            ...
            echo "<script>alert('Error al publicar la oferta');</script>";
        }
    } else {
        echo "<script>alert('Error al registrar la oferta');</script>";
    }
}
...
if (isset($_POST["delete_publicacion"])) {
    ...
    if (mysqli_query($conexion, $query_delete)) {
        echo "<script>alert('Publicación eliminada con éxito'); document.location.href = 'PaginaPerfilEmpresa.php';</script>";
    } else {
...
if (isset($_POST["edit_publicacion"])) {
    ...
    if (mysqli_query($conexion, $query_edit)) {
        echo "<script>alert('Publicación editada con éxito'); document.location.href = 'PaginaPerfilEmpresa.php';</script>";
    } else {
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="PaginaPerfilEmpresa.php">MENU</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="uploadModalLabel">Cambiar Foto de Perfil</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="form-group">
                            <label for="nombre"style="color: black;">Nombre Empresa</label>
                            <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $info_adicional['NombreEmpresa']; ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="celular" name="celular" value="<?php echo $info_adicional['TelefonoCelular']; ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="nit"style="color: black;">NIT</label>
                            <textarea class="form-control" id="nit" name="nit" required><?php echo $info_adicional['NIT']; ?></textarea>
                        </div>
    ...
    <div class="modal fade" id="publicarModal" tabindex="-1" role="dialog" aria-labelledby="publicarModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="publicarModalLabel">Publicar Oferta</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="editPublicacionModal" tabindex="-1" role="dialog" aria-labelledby="editPublicacionModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="editPublicacionModalLabel">Editar Publicación</h1>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
